...
import { IntroComponent } from './general/intro/intro.component';
...
import { DirectMessagingComponent } from './product-section/collections/chat/messages/direct-messaging/direct-messaging.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'home/direct-messages/:id', component: DirectMessagingComponent },
