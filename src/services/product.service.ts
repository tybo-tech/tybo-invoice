...
export class ProductService {
  ...
  constructor(
    ...
    this.tyboShopBehaviorSubject =
      new BehaviorSubject<TyboShopModel>(null);
  ...
  updateTyboShopState(tyboShop: TyboShopModel) {
    if (tyboShop && tyboShop.Ladies && tyboShop.Ladies.length) {
      const currentState = this.tyboShopBehaviorSubject.value;
      if (currentState && currentState.Ladies && currentState.Ladies.length) {
        this.tyboShopBehaviorSubject.next(currentState);
        currentState.Ladies.push(...tyboShop.Ladies);
        currentState.Mens.push(...tyboShop.Mens);
