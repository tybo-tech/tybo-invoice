...
import { HomeNavUx, HomeTabModel, LoaderUx, NavHistoryUX, ProductsPagingModel } from 'src/models/UxModel.model';
...
export class UxService {
  ...
  constructor() {
    ...
    this.searchStringBehaviorSubject = new BehaviorSubject<string>('');
